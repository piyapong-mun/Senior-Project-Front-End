...
export async function GET(req: Request) {
  try {
    ...
    console.log("url", `${BACKEND}/activity/student/challenge/${activityId}/${stdId}`)

    const res = await fetch(`${BACKEND}/activity/student/challenge/${activityId}/${stdId}`, {
      method: "GET",
      headers: {
    ...
    if (!res.ok) {
      ...
      throw new Error(`Failed to fetch challenge progress: ${errText}`);
    }
    ...
    console.error("Error fetching challenge progress:", e);
    return NextResponse.json(
